...
//        performSegue(withIdentifier: "fromContosoToToday", sender: self)
//    }
...
class WelcomeToContosoVC: UIViewController {
//    @IBAction func moveToToday(_ sender: UIButton) {
//        performSegue(withIdentifier: "fromContosoToToday", sender: nil)
//    }
    override func viewDidLoad() {
        super.viewDidLoad()
