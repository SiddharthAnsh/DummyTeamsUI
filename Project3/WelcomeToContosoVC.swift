...
class WelcomeToContosoVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        getStartedButton.addTarget(self, action: #selector(navigateToNextScreen), for: .touchUpInside)
    ...
    @objc func navigateToNextScreen() {
        guard let nextVC = UIStoryboard(name: "Main", bundle: nil)
                .instantiateViewController(withIdentifier: "TodayViewController") as? TodayViewController
        else {
            print("Could not instantiate TodayViewController")
            return
        }
        ...
        if let navController = self.navigationController {
            ...
            nextVC.modalPresentationStyle = .currentContext  // Keeps the parent context
            nextVC.modalTransitionStyle = .coverVertical  // Default slide-in animation
